...
const InviteMemberOnCreateEventModal = ({
  onClose,
  onSubmitClick,
  selectedMembersId,
  selectedMembersList,
  ...
  // function for get all pre added members data on api call
  ...
  // function for submit button click for api call to invite the user on create event
...
export default InviteMemberOnCreateEventModal;
