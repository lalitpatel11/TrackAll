...
const EditCommunityPost = ({
  ...
  const onSubmit = (values: any) => {
    ...
    feedBackData.append('postid', communityId);
  ...
  // function for remove image click
