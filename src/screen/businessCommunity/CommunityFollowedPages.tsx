...
const CommunityFollowedPages = ({navigation}: {navigation: any}) => {
  ...
  // function for search all community data api call
      ...
      {!pageLoader ? (
        allCommunity?.length > 0 ? (
          ...
          <View style={styles.noDataContainer}>
            {!noData ? (
              <Text style={styles.noDataText}>No Community Followed. </Text>
            ) : (
...
export default CommunityFollowedPages;
