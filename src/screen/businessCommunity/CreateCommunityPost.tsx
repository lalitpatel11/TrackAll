...
const CreateCommunityPost = ({
  ...
  const onSubmit = (values: any) => {
    ...
    feedBackData.append('communityid', communityId);
    feedBackData.append('post', values.description);

    BusinessCommunityService.postBusinessAddPost(feedBackData)
      .then((response: any) => {
        ...
        <Formik
          ...
          {({
            ...
            <View style={styles.body}>
              ...
              <View>
                <TextInput
                  placeholder="Write something for your community post?"
