...
import RecentMonthData from '../../expenseManagement/RecentMonthData';
import AddedExpensesTab from '../../expenseManagement/AddedExpensesTab';
import AddedBudgetaryTab from '../../expenseManagement/AddedBudgetaryTab';
import CustomHeader from '../../../constants/CustomHeader';
import DeleteAlertModal from '../../groups/DeleteAlertModal';
import CommonToast from '../../../constants/CommonToast';
import AddExpansesButton from '../../expenseManagement/AddExpansesButton';
import BusinessService from '../../../service/BusinessService';
import AsyncStorage from '@react-native-async-storage/async-storage';
// internal imports

const BusinessExpenseManagement = ({navigation}: {navigation: any}) => {
  ...
  const getData = async () => {
    ...
    BusinessService.postBusinessExpanseManagementHome(body)
      .then((response: any) => {
        ...
        if (barData.length > 0) {
          ...
          for (let index = 0; index < 12; index++) {
            const pData = {
              ...
              spacing: 2,
              labelWidth: 40,
              labelTextStyle: {color: colors.THEME_BLACK},
  ...
  // function for delete button click on api call to delete budget
  const handleDelete = () => {
            ...
            <ScrollView
              ...
              <View style={styles.body}>
                <View style={styles.textDirection}>
                  <Text style={styles.labelText}>Monthly data</Text>
                </View>
...
export default BusinessExpenseManagement;
